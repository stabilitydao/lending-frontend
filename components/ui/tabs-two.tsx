...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-7 items-center justify-center rounded-md bg-purple-500/20  text-muted-foreground",
      className
    )}
    {...props}
  />
